...
#--------------------------------------------------------------- ÖDEV            
            # Tablo adıyla aynı olan bir değişken
            table_name = self.database

            # Yeni sütun adını belirleme ve veri türünü atama
            new_column_name = 'Screenshots'
            new_column_type = 'TEXT'

            # Yeni bir sütun ekleyen sorguyu çalıştırma
            alter_query = f"ALTER TABLE projects ADD COLUMN {new_column_name} {new_column_type}"
            cursor.execute(alter_query)
            print("YENİ KOLON EKLENDİ")           
